...
- Todos os métodos do SDK utilizam [fetch](https://developer.mozilla.org/pt-BR/docs/Web/API/Fetch_API/Using_Fetch)
e retornam Promises.
...
**Geralmente, você não precisa criar Selectors ou Instances** para utilizá-los. Em vários casos,
...
Ao retornarem, essas Promises resolvem para um desses três tipos:
