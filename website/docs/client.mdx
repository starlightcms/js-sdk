...
A [função `makeStarlightClient()`](/api/function/makeStarlightClient) recebe as mesmas configurações que o método
...
[nessa página do guia sobre respostas](./requesting-data/requests-and-responses#starlight-error) e
